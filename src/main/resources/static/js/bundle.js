...
class SignUpModal extends _Modal__WEBPACK_IMPORTED_MODULE_0__["Modal"] {
    constructor(context, _username = "", _password = "", _reEnteredPassword = "") {
        super(context);
        this._username = _username;
        this._password = _password;
        this._reEnteredPassword = _reEnteredPassword;
    ...
    set reEnteredPassword(value) {
        this._reEnteredPassword = value;
    }
    activateModalListeners() {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.modalContext.attr('id') + ' button')
